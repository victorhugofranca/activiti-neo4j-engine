 ...
 * @author Joram Barrez
 */
public class Neo4jJobDataManager extends AbstractNeo4jDataManager<JobEntity>
	...
	public List<JobEntity> findJobsByLockOwner(String lockOwner, int start,
			int maxNrOfJobs) {
		throw new UnsupportedOperationException();
	}
	...
	public List<JobEntity> findJobsByExecutionId(String executionId) {
		...
		// && jobEntity.getExecutionId().equals(executionId)) {
	...
	public List<Job> findJobsByTypeAndProcessDefinitionIds(
			String jobHandlerType, List<String> processDefinitionIds) {
		throw new UnsupportedOperationException();
	}
	...
	public List<Job> findJobsByTypeAndProcessDefinitionKeyNoTenantId(
		...
		// && processDefinitionEntity.getId().equals(
		// jobEntity.getProcessDefinitionId())
